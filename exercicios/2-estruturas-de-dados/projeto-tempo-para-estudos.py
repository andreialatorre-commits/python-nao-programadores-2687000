...
total_horas = int(input('Quantas horas por dia você estuda? '))
...
print(f'Olá {nome}, você estuda {total_dias} dias por semana, totalizando {total_dias * total_horas} horas semanais de estudo no curso {curso}.')